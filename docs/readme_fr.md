...
```md
[![Les Stats GitHub de Coffee](https://mdstats.vercel.app/api?username=coffee)](https://github.com/CoffeeBit/coffeestats)
```
...
```md
![Les Stats GitHub de Coffee](https://mdstats.vercel.app/api?username=coffee&hide=contribs,prs)
```
...
```md
![Les Stats GitHub de Coffee](https://mdstats.vercel.app/api?username=coffee&show_icons=true)
```
...
```md
![Les Stats GitHub de Coffee](https://mdstats.vercel.app/api?username=coffee&show_icons=true&theme=radical)
```
...
```md
[![Carte ReadMe](https://mdstats.vercel.app/api/pin/?username=coffee&repo=mdstats)](https://github.com/CoffeeBit/coffeestats)
```
