...
Extrémité: `api/pin?username=coffee&repo=mdstats`

```md
[![Carte ReadMe](https://coffeestats.vercel.app/api/pin/?username=coffee&repo=mdstats)](https://github.com/CoffeeBit/coffeestats)
```
